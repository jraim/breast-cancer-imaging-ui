...
export default function Instructions() {
    return (
        <div className='cui flex column jc-center ai-center width-100'>
            <div className='cui width-70'>
                <h2 className='cui text-align-left text-color-blue pb-12 mb-12'>Instructions</h2>
                <List divided relaxed className='cui text-align-left'>
                    <List.Item>
                        <List.Icon name='angle right' size='large' verticalAlign='middle' style={styles.icon} />
                        <List.Content>
                    ...
                    <List.Item>
                        <List.Icon name='angle right' size='large' verticalAlign='middle' style={styles.icon} />
                        <List.Content>
                            <List.Header>Select a MRI pass reference</List.Header>
